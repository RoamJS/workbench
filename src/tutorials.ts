...
export const show = () => {
  ...
  jsPanel.create({
    ...
    headerTitle:
      '<div style="font-variant: normal;position:relative;left:5px;z-index:1000;width:300px;color:white !important;padding-top:2px;">Tutorials for Roam<sup>42</sup> and Roam</div>',
    iconfont: [
