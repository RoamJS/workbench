    ...
    roam42.quickRef.component = {
      ...
      initialize() {
        ...
        this.rqrQuickReferencePanel = jsPanel.create({
          ...
          content: `<iframe src="${window.roam42.host.includes('roamjs.com') ? 'https://roamjs.com/quickref/index.html' : 'https://roam-quickref.glitch.me/'}" id="iframeRqrQuickReferencePanel" style="width: 100%; height: 100%;"></iframe>`,
          onwindowresize: true,
          dragit: {
            containment: 10,
            snap: {
